...
(function(){
  ...
  function init() {
    ...
    NodeMCU.addProcessor("connected", queryBoardProcess);
  }
  
  function queryBoardProcess(data, callback) {
    NodeMCU.Core.Utils.executeExpression("process.env", function(result) {
      var json = {};
      if (result!==undefined) {
        try {       
      ...
      NodeMCU.callProcessor("environmentVar", environmentData, function(data) {
